...
namespace ImageEvaluator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IDoubleLightImageReader imageReader = new Factory_DoubleLight16bitImageReader().Factory(logger, width, 2);
            ...
            IImagePreProcessor preProcessor = new Factory_ImagePreProcessor().Factory(logger, 4096, width, height);
